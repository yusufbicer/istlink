...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className={`${isMobile ? 'py-2' : 'py-20'} relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50`} key={`how-it-works-${i18n.language}`}>
      {/* Enhanced background elements to match blog design */}
