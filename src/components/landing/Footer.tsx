...
const footerLinks = [
  {
    title: "Solutions",
    links: [
      { label: "Consolidated Shipping", href: "#" },
      { label: "Supplier Management", href: "#" },
      { label: "Order Tracking", href: "#" },
      { label: "Customs Documentation", href: "#" },
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {footerLinks.map((section, index) => (
                <Collapsible key={index} open={openSection === section.title} onOpenChange={() => toggleSection(section.title)}>
                  <CollapsibleTrigger className="w-full flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <CollapsibleContent className="pt-2 pb-3">
                    <ul className="grid grid-cols-2 gap-x-4 gap-y-2">
                      {section.links.map((link, i) => (
                        <li key={i}>
                          <a href={link.href} className="text-sm text-gray-600 hover:text-metallic-blue transition-colors">
                            {link.label}
                          </a>
                        </li>
                      ))}
            ...
            {footerLinks.map((section, index) => (
              <div key={index} className="col-span-1">
                ...
                <ul className="space-y-3">
                  {section.links.map((link, i) => (
                    <li key={i}>
                      <a href={link.href} className="text-gray-600 hover:text-metallic-blue transition-colors">
                        {link.label}
                      </a>
                    </li>
                  ))}
