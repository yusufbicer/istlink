          ...
          <div className="grid grid-cols-1 gap-3 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-sm font-semibold mb-1 bg-red-100" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>{feature.title}</h3>
                <p className="text-gray-600 text-xs mb-2 bg-blue-100" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>{feature.description}</p>
